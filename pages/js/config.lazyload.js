  ...
  .config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              //     name: 'studentService',
              //     files: [
              //         'js/services/student/student-service.js'
              //     ]
              // },
              {
                  name: 'student.Homework',
                  files: [
                      'js/services/student/homework-service.js'
                  ]
              },
              {
                  name: 'student.Class',
                  files: [
                      'js/services/student/class-service.js'
                  ]
              },
              {
                  name: 'student.Course',
                  files: [
                      'js/services/student/course-service.js'
                  ]
              },
              {
                  name: 'student.Group',
                  files: [
                      'js/services/student/group-service.js'
                  ]
              },
              // {
              //     name: 'teacherService',
              //     files: [
              //         'js/services/teacher/teacher-service.js'
              //     ]
              // },
              {
                  name: 'teacher.Class',
                  files: [
                      'js/services/teacher/class-service.js'
                  ]
              },
              {
                  name: 'teacher.Course',
                  files: [
                      'js/services/teacher/course-service.js'
                  ]
              },
              {
                  name: 'teacher.Task',
                  files: [
                      'js/services/teacher/task-service.js'
                  ]
              },
          ]
      });
